...
// GetWaySinglePair is the function that will return the ask and bid or error.
func GetWaySinglePair(w http.ResponseWriter, r *http.Request) {
	...
	if eID == "1" {
		//	fmt.Println("Request Leave Gateway For Bittrex")
		body, _ := GetTicker("http://localhost:5030/pair/price?pair=" + pair + "&eid=" + eID + "")
